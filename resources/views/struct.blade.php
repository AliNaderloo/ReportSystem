        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
                ...
                <li>
                  ...
                  <ul class="menu">
                    <li><!-- start message -->
                      <a href="#">
                        <div class="pull-left">
                          <img class="profPic" src="{{ asset('img/ProfilePics/Admin.jpeg') }}" class="img-circle profPic" alt="User Image">
                        </div>
                        <h4>
                          Support Team
            ...
            <li class="dropdown user user-menu">
              <a href="#" id="adminDrop" >
                <img src="{{ asset('img/ProfilePics/Admin.jpeg') }}" class=" profPic user-image" alt="User Image">
                <span class="hidden-xs">{{session('name')}}</span>
              </a>
              <ul id="adminUl" class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img src="{{ asset('img/ProfilePics/Admin.jpeg') }}" class=" profPic img-circle profPic" alt="User Image">
                  <p>
                    {{session('name')}} 
                  </p>
                </li>
  ...
  <section class="sidebar">
    ...
    <div class="user-panel">
      <div class="pull-right image">
        <img src="{{ asset('img/ProfilePics/Admin.jpeg') }}" class="img-circle profPic" alt="User Image">
      </div>
